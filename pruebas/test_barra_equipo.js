...
const FIX=(rol)=>({
  ...
  clientes:[{cli_id:"CLI-DEMO-01",nombre:"Cliente Demo Norte",tipo:"Empresa"},{cli_id:"CLI-DEMO-02",nombre:"Cliente Demo Sur",tipo:"Empresa"},
            {cli_id:"CLI-DEMO-03",nombre:"Cliente Demo Centro",tipo:"Empresa"}],
