...
prueba(/const VERSION = \{ n:"442"/.test(app),"Freelance debe anunciar v442");
...
prueba(/const VERSION = \{ n:"154"/.test(web),"Sistema Web debe anunciar b154");
prueba(/const CACHE = "freelance-v240"/.test(sw),"la caché debe renovarse");
