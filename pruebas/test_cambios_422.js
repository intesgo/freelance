...
/* ── freelance-completo ── */
prueba(/const VERSION = \{ n:"484"/.test(app),"Freelance debe anunciar v481");
...
prueba(/const VERSION = \{ n:"246"/.test(web),"Sistema Web debe anunciar b235");
prueba(/const CACHE = "freelance-v360"/.test(sw),"la caché debe renovarse");
