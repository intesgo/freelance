...
/* ── freelance-completo ── */
prueba(/const VERSION = \{ n:"485"/.test(app),"Freelance debe anunciar v481");
...
prueba(/const VERSION = \{ n:"247"/.test(web),"Sistema Web debe anunciar b235");
prueba(/const CACHE = "freelance-v361"/.test(sw),"la caché debe renovarse");
