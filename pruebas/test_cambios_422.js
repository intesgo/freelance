...
prueba(/const VERSION = \{ n:"456"/.test(app),"Freelance debe anunciar v456");
...
prueba(/const VERSION = \{ n:"170"/.test(web),"Sistema Web debe anunciar b170");
prueba(/const CACHE = "freelance-v264"/.test(sw),"la caché debe renovarse");
