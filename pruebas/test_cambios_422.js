...
prueba(/const VERSION = \{ n:"441"/.test(app),"Freelance debe anunciar v441");
...
prueba(/const VERSION = \{ n:"153"/.test(web),"Sistema Web debe anunciar b153");
prueba(/const CACHE = "freelance-v239"/.test(sw),"la caché debe renovarse");
