...
/* ── freelance-completo ── */
prueba(/const VERSION = \{ n:"486"/.test(app),"Freelance debe anunciar v481");
...
prueba(/const VERSION = \{ n:"250"/.test(web),"Sistema Web debe anunciar b235");
prueba(/const CACHE = "freelance-v364"/.test(sw),"la caché debe renovarse");
