...
/* ── freelance-completo ── */
prueba(/const VERSION = \{ n:"487"/.test(app),"Freelance debe anunciar v481");
...
prueba(/const VERSION = \{ n:"251"/.test(web),"Sistema Web debe anunciar b235");
prueba(/const CACHE = "freelance-v365"/.test(sw),"la caché debe renovarse");
