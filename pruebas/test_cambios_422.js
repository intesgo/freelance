...
prueba(/const VERSION = \{ n:"444"/.test(app),"Freelance debe anunciar v444");
...
prueba(/const VERSION = \{ n:"156"/.test(web),"Sistema Web debe anunciar b156");
prueba(/const CACHE = "freelance-v242"/.test(sw),"la caché debe renovarse");
