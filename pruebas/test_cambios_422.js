...
prueba(/const VERSION = \{ n:"449"/.test(app),"Freelance debe anunciar v449");
...
prueba(/const VERSION = \{ n:"168"/.test(web),"Sistema Web debe anunciar b168");
prueba(/const CACHE = "freelance-v255"/.test(sw),"la caché debe renovarse");
