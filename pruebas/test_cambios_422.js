...
prueba(/const VERSION = \{ n:"429"/.test(app),"Freelance debe anunciar v429");
...
prueba(/const VERSION = \{ n:"146"/.test(web),"Sistema Web debe anunciar b146");
prueba(/const CACHE = "freelance-v223"/.test(sw),"la caché debe renovarse");
