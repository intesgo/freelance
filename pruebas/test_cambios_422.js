...
prueba(/const VERSION = \{ n:"445"/.test(app),"Freelance debe anunciar v445");
...
prueba(/const VERSION = \{ n:"157"/.test(web),"Sistema Web debe anunciar b157");
prueba(/const CACHE = "freelance-v243"/.test(sw),"la caché debe renovarse");
