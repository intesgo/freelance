...
prueba(/const VERSION = \{ n:"457"/.test(app),"Freelance debe anunciar v457");
...
prueba(/const VERSION = \{ n:"171"/.test(web),"Sistema Web debe anunciar b171");
prueba(/const CACHE = "freelance-v265"/.test(sw),"la caché debe renovarse");
