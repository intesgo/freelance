...
prueba(/const VERSION = \{ n:"440"/.test(app),"Freelance debe anunciar v440");
...
prueba(/const VERSION = \{ n:"152"/.test(web),"Sistema Web debe anunciar b152");
prueba(/const CACHE = "freelance-v238"/.test(sw),"la caché debe renovarse");
