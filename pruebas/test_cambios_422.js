...
/* ── freelance-completo ── */
prueba(/const VERSION = \{ n:"488"/.test(app),"Freelance debe anunciar v481");
...
prueba(/const VERSION = \{ n:"253"/.test(web),"Sistema Web debe anunciar b235");
prueba(/const CACHE = "freelance-v367"/.test(sw),"la caché debe renovarse");
