...
/* ── freelance-completo ── */
prueba(/const VERSION = \{ n:"482"/.test(app),"Freelance debe anunciar v481");
...
prueba(/const VERSION = \{ n:"243"/.test(web),"Sistema Web debe anunciar b235");
prueba(/const CACHE = "freelance-v356"/.test(sw),"la caché debe renovarse");
...
prueba(/const VERSION = \{ n:"79"/.test(prov),"proveedor debe anunciar v79");
