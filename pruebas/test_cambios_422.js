...
prueba(/const VERSION = \{ n:"446"/.test(app),"Freelance debe anunciar v446");
...
prueba(/const VERSION = \{ n:"158"/.test(web),"Sistema Web debe anunciar b158");
prueba(/const CACHE = "freelance-v244"/.test(sw),"la caché debe renovarse");
