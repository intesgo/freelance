...
prueba(/const VERSION = \{ n:"438"/.test(app),"Freelance debe anunciar v438");
...
prueba(/const VERSION = \{ n:"150"/.test(web),"Sistema Web debe anunciar b150");
prueba(/const CACHE = "freelance-v236"/.test(sw),"la caché debe renovarse");
