...
prueba(/const VERSION = \{ n:"462"/.test(app),"Freelance debe anunciar v462");
...
prueba(/const VERSION = \{ n:"176"/.test(web),"Sistema Web debe anunciar b176");
prueba(/const CACHE = "freelance-v271"/.test(sw),"la caché debe renovarse");
