...
/* ── freelance-completo ── */
prueba(/const VERSION = \{ n:"477"/.test(app),"Freelance debe anunciar v477");
...
prueba(/const VERSION = \{ n:"215"/.test(web),"Sistema Web debe anunciar b215");
prueba(/const CACHE = "freelance-v322"/.test(sw),"la caché debe renovarse");
...
prueba(/const VERSION = \{ n:"61"/.test(socio),"socio debe anunciar v61");
prueba(/const VERSION = \{ n:"194"/.test(comi),"comisionista debe anunciar v194");
