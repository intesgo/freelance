...
prueba(/const VERSION = \{ n:"439"/.test(app),"Freelance debe anunciar v439");
...
prueba(/const VERSION = \{ n:"151"/.test(web),"Sistema Web debe anunciar b151");
prueba(/const CACHE = "freelance-v237"/.test(sw),"la caché debe renovarse");
