...
prueba(/const VERSION = \{ n:"450"/.test(app),"Freelance debe anunciar v450");
...
prueba(/const VERSION = \{ n:"169"/.test(web),"Sistema Web debe anunciar b169");
prueba(/const CACHE = "freelance-v257"/.test(sw),"la caché debe renovarse");
