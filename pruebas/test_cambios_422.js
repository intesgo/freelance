...
prueba(/const VERSION = \{ n:"427"/.test(app),"Freelance debe anunciar v427");
...
prueba(/const VERSION = \{ n:"144"/.test(web),"Sistema Web debe anunciar b144");
prueba(/const CACHE = "freelance-v219"/.test(sw),"la caché debe renovarse");
