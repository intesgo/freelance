...
ok(/const VERSION = \{ n:"452"/.test(L("freelance-completo.html")),"Freelance debe anunciar v452");
...
ok(/const CACHE = "freelance-v259"/.test(sw),"la caché debe renovarse a v259");
