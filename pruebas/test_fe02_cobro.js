...
ok(/const VERSION = \{ n:"455"/.test(L("freelance-completo.html")),"Freelance debe anunciar v455");
...
ok(/const CACHE = "freelance-v262"/.test(sw),"la caché debe renovarse a v262");
