...
ok(/const VERSION = \{ n:"454"/.test(L("freelance-completo.html")),"Freelance debe anunciar v454");
...
ok(/const CACHE = "freelance-v261"/.test(sw),"la caché debe renovarse a v261");
