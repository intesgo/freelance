...
ok(/const VERSION = \{ n:"465"/.test(L("freelance-completo.html")),"Freelance debe anunciar v465");
...
ok(/const CACHE = "freelance-v276"/.test(sw),"la caché debe renovarse a v276");
