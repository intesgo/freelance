...
ok(/const VERSION = \{ n:"450"/.test(L("freelance-completo.html")),"Freelance debe anunciar v450");
...
ok(/const CACHE = "freelance-v257"/.test(sw),"la caché debe renovarse a v257");
