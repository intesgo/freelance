...
ok(/const VERSION = \{ n:"451"/.test(L("freelance-completo.html")),"Freelance debe anunciar v451");
...
ok(/const VERSION = \{ n:"169"/.test(L("sistema-web.html")),"Sistema Web debe anunciar b169");
ok(/const CACHE = "freelance-v258"/.test(sw),"la caché debe renovarse a v258");
