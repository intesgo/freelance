...
ok(/const VERSION = \{ n:"467"/.test(L("freelance-completo.html")),"Freelance debe anunciar v467");
...
ok(/const VERSION = \{ n:"184"/.test(L("sistema-web.html")),"Sistema Web debe anunciar b184");
ok(/const CACHE = "freelance-v281"/.test(sw),"la caché debe renovarse a v281");
