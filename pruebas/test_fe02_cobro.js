...
ok(/const VERSION = \{ n:"453"/.test(L("freelance-completo.html")),"Freelance debe anunciar v453");
...
ok(/const CACHE = "freelance-v260"/.test(sw),"la caché debe renovarse a v260");
