...
ok(/const VERSION = \{ n:"449"/.test(L("freelance-completo.html")),"Freelance debe anunciar v449");
...
ok(/const CACHE = "freelance-v256"/.test(sw),"la caché debe renovarse a v256");
