...
probar(/const VERSION = \{ n:"470"/.test(app), "la aplicación debe anunciar v470");
probar(/const CACHE = "freelance-v290"/.test(sw), "el service worker debe renovar la caché a v290");
