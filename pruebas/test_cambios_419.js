...
probar(/const VERSION = \{ n:"452"/.test(app), "la aplicación debe anunciar v452");
probar(/const CACHE = "freelance-v259"/.test(sw), "el service worker debe renovar la caché a v259");
