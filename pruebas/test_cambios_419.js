...
probar(/const VERSION = \{ n:"432"/.test(app), "la aplicación debe anunciar v432");
probar(/const CACHE = "freelance-v229"/.test(sw), "el service worker debe renovar la caché a v229");
