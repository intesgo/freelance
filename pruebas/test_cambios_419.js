...
probar(/const VERSION = \{ n:"455"/.test(app), "la aplicación debe anunciar v455");
probar(/const CACHE = "freelance-v262"/.test(sw), "el service worker debe renovar la caché a v262");
