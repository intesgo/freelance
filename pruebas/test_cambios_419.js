...
probar(/const VERSION = \{ n:"450"/.test(app), "la aplicación debe anunciar v450");
probar(/const CACHE = "freelance-v257"/.test(sw), "el service worker debe renovar la caché a v257");
