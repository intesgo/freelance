...
probar(/const VERSION = \{ n:"454"/.test(app), "la aplicación debe anunciar v454");
probar(/const CACHE = "freelance-v261"/.test(sw), "el service worker debe renovar la caché a v261");
