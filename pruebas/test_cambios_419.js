...
probar(/const VERSION = \{ n:"462"/.test(app), "la aplicación debe anunciar v462");
probar(/const CACHE = "freelance-v271"/.test(sw), "el service worker debe renovar la caché a v271");
