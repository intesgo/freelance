...
probar(/const VERSION = \{ n:"473"/.test(app), "la aplicación debe anunciar v473");
probar(/const CACHE = "freelance-v301"/.test(sw), "el service worker debe renovar la caché a v301");
