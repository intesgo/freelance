...
probar(/const VERSION = \{ n:"433"/.test(app), "la aplicación debe anunciar v433");
probar(/const CACHE = "freelance-v230"/.test(sw), "el service worker debe renovar la caché a v230");
