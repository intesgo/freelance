...
probar(/const VERSION = \{ n:"439"/.test(app), "la aplicación debe anunciar v439");
probar(/const CACHE = "freelance-v237"/.test(sw), "el service worker debe renovar la caché a v237");
