...
probar(/const VERSION = \{ n:"443"/.test(app), "la aplicación debe anunciar v443");
probar(/const CACHE = "freelance-v241"/.test(sw), "el service worker debe renovar la caché a v241");
