...
probar(/const VERSION = \{ n:"442"/.test(app), "la aplicación debe anunciar v442");
probar(/const CACHE = "freelance-v240"/.test(sw), "el service worker debe renovar la caché a v240");
