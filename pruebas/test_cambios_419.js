...
probar(/const VERSION = \{ n:"445"/.test(app), "la aplicación debe anunciar v445");
probar(/const CACHE = "freelance-v243"/.test(sw), "el service worker debe renovar la caché a v243");
