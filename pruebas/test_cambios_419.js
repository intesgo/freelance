...
probar(/const VERSION = \{ n:"478"/.test(app), "la aplicación debe anunciar v478");
probar(/const CACHE = "freelance-v324"/.test(sw), "el service worker debe renovar la caché a v324");
