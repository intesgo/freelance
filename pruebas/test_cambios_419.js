...
probar(/const VERSION = \{ n:"434"/.test(app), "la aplicación debe anunciar v434");
probar(/const CACHE = "freelance-v231"/.test(sw), "el service worker debe renovar la caché a v231");
