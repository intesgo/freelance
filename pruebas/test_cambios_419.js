...
probar(/const VERSION = \{ n:"476"/.test(app), "la aplicación debe anunciar v476");
probar(/const CACHE = "freelance-v321"/.test(sw), "el service worker debe renovar la caché a v321");
