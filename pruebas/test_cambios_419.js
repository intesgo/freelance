...
probar(/const VERSION = \{ n:"420"/.test(app), "la aplicación debe anunciar v420");
probar(/const CACHE = "freelance-v210"/.test(sw), "el service worker debe renovar la caché a v210");
...
probar(/aspect-ratio:0\.62\/1;min-height:440px/.test(app), "la foto principal debe disponer de un contenedor más alto");
probar(/object-fit:scale-down/.test(app), "la foto principal debe reducirse sin recorte");
