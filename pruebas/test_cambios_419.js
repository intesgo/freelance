...
probar(/const VERSION = \{ n:"453"/.test(app), "la aplicación debe anunciar v453");
probar(/const CACHE = "freelance-v260"/.test(sw), "el service worker debe renovar la caché a v260");
