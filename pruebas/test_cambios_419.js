...
probar(/const VERSION = \{ n:"430"/.test(app), "la aplicación debe anunciar v430");
probar(/const CACHE = "freelance-v227"/.test(sw), "el service worker debe renovar la caché a v227");
