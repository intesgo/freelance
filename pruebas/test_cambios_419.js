...
probar(/const VERSION = \{ n:"441"/.test(app), "la aplicación debe anunciar v441");
probar(/const CACHE = "freelance-v239"/.test(sw), "el service worker debe renovar la caché a v239");
