...
probar(/const VERSION = \{ n:"438"/.test(app), "la aplicación debe anunciar v438");
probar(/const CACHE = "freelance-v236"/.test(sw), "el service worker debe renovar la caché a v236");
