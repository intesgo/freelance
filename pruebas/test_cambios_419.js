...
probar(/const VERSION = \{ n:"475"/.test(app), "la aplicación debe anunciar v475");
probar(/const CACHE = "freelance-v320"/.test(sw), "el service worker debe renovar la caché a v320");
