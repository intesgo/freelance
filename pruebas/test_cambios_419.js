...
probar(/const VERSION = \{ n:"459"/.test(app), "la aplicación debe anunciar v459");
probar(/const CACHE = "freelance-v267"/.test(sw), "el service worker debe renovar la caché a v267");
