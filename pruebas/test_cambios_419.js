...
probar(/const VERSION = \{ n:"474"/.test(app), "la aplicación debe anunciar v474");
probar(/const CACHE = "freelance-v314"/.test(sw), "el service worker debe renovar la caché a v314");
