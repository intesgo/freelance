...
probar(/const VERSION = \{ n:"479"/.test(app), "la aplicación debe anunciar v479");
probar(/const CACHE = "freelance-v325"/.test(sw), "el service worker debe renovar la caché a v325");
