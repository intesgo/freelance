...
probar(/const VERSION = \{ n:"464"/.test(app), "la aplicación debe anunciar v464");
probar(/const CACHE = "freelance-v274"/.test(sw), "el service worker debe renovar la caché a v274");
