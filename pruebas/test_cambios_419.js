...
probar(/const VERSION = \{ n:"451"/.test(app), "la aplicación debe anunciar v451");
probar(/const CACHE = "freelance-v258"/.test(sw), "el service worker debe renovar la caché a v258");
