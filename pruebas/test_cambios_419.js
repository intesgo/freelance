...
probar(/const VERSION = \{ n:"425"/.test(app), "la aplicación debe anunciar v425");
probar(/const CACHE = "freelance-v217"/.test(sw), "el service worker debe renovar la caché a v217");
