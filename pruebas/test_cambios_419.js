...
probar(/const VERSION = \{ n:"469"/.test(app), "la aplicación debe anunciar v469");
probar(/const CACHE = "freelance-v288"/.test(sw), "el service worker debe renovar la caché a v288");
