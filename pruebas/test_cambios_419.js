...
probar(/const VERSION = \{ n:"477"/.test(app), "la aplicación debe anunciar v477");
probar(/const CACHE = "freelance-v322"/.test(sw), "el service worker debe renovar la caché a v322");
