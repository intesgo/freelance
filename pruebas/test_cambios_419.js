...
probar(/const VERSION = \{ n:"471"/.test(app), "la aplicación debe anunciar v471");
probar(/const CACHE = "freelance-v293"/.test(sw), "el service worker debe renovar la caché a v293");
