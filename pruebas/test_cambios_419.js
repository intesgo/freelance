...
probar(/const VERSION = \{ n:"481"/.test(app), "la aplicación debe anunciar v481");
probar(/const CACHE = "freelance-v348"/.test(sw), "el service worker debe renovar la caché a v346");
