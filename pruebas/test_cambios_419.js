...
probar(/const VERSION = \{ n:"426"/.test(app), "la aplicación debe anunciar v426");
probar(/const CACHE = "freelance-v218"/.test(sw), "el service worker debe renovar la caché a v218");
