...
probar(/const VERSION = \{ n:"446"/.test(app), "la aplicación debe anunciar v446");
probar(/const CACHE = "freelance-v244"/.test(sw), "el service worker debe renovar la caché a v244");
