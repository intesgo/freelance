...
probar(/const VERSION = \{ n:"465"/.test(app), "la aplicación debe anunciar v465");
probar(/const CACHE = "freelance-v276"/.test(sw), "el service worker debe renovar la caché a v276");
