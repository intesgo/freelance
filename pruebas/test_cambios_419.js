...
probar(/const VERSION = \{ n:"447"/.test(app), "la aplicación debe anunciar v447");
probar(/const CACHE = "freelance-v245"/.test(sw), "el service worker debe renovar la caché a v245");
