...
probar(/const VERSION = \{ n:"487"/.test(app), "la aplicación debe anunciar v481");
probar(/const CACHE = "freelance-v365"/.test(sw), "el service worker debe renovar la caché a v346");
