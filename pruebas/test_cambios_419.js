...
probar(/const VERSION = \{ n:"437"/.test(app), "la aplicación debe anunciar v437");
probar(/const CACHE = "freelance-v234"/.test(sw), "el service worker debe renovar la caché a v234");
