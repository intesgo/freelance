...
probar(/const VERSION = \{ n:"449"/.test(app), "la aplicación debe anunciar v449");
probar(/const CACHE = "freelance-v256"/.test(sw), "el service worker debe renovar la caché a v256");
