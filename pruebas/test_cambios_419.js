...
probar(/const VERSION = \{ n:"444"/.test(app), "la aplicación debe anunciar v444");
probar(/const CACHE = "freelance-v242"/.test(sw), "el service worker debe renovar la caché a v242");
