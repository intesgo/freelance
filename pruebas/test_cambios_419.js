...
probar(/const VERSION = \{ n:"429"/.test(app), "la aplicación debe anunciar v429");
probar(/const CACHE = "freelance-v226"/.test(sw), "el service worker debe renovar la caché a v226");
