...
probar(/const VERSION = \{ n:"436"/.test(app), "la aplicación debe anunciar v436");
probar(/const CACHE = "freelance-v233"/.test(sw), "el service worker debe renovar la caché a v233");
