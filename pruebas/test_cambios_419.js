...
probar(/const VERSION = \{ n:"448"/.test(app), "la aplicación debe anunciar v448");
probar(/const CACHE = "freelance-v248"/.test(sw), "el service worker debe renovar la caché a v248");
