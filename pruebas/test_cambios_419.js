...
probar(/const VERSION = \{ n:"435"/.test(app), "la aplicación debe anunciar v435");
probar(/const CACHE = "freelance-v232"/.test(sw), "el service worker debe renovar la caché a v232");
