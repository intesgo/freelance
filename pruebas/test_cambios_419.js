...
probar(/const VERSION = \{ n:"431"/.test(app), "la aplicación debe anunciar v431");
probar(/const CACHE = "freelance-v228"/.test(sw), "el service worker debe renovar la caché a v228");
