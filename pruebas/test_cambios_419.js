...
probar(/const VERSION = \{ n:"466"/.test(app), "la aplicación debe anunciar v466");
probar(/const CACHE = "freelance-v278"/.test(sw), "el service worker debe renovar la caché a v278");
