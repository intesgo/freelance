...
probar(/const VERSION = \{ n:"440"/.test(app), "la aplicación debe anunciar v440");
probar(/const CACHE = "freelance-v238"/.test(sw), "el service worker debe renovar la caché a v238");
