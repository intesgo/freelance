...
probar(/const VERSION = \{ n:"456"/.test(app), "la aplicación debe anunciar v456");
probar(/const CACHE = "freelance-v263"/.test(sw), "el service worker debe renovar la caché a v263");
