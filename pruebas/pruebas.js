...
const PLAN = [
  ...
  { arnes:"test_nombre_cliente.js",   que:"el nombre del cliente (persona/empresa, mayúsculas, RUC) es una sola verdad en web y freelance", apps:[null] },
  ...
  { arnes:"test_qq_carrito.js",      que:"el total en quintales sale de la oferta, no del texto",
    ...
    salvo:{ "freelance-completo": "su módulo de pedido no arma un total en quintales del carrito: no hay qué medir",
            "Comisionista": "FE01_QUITA_COBRO · al quitar el cobro de flete/estibada dejó de armar un total en quintales del carrito en pantalla: no hay qué medir" } },
  ...
  { arnes:"test_precios_solo_freelance.js", que:"Solo el Freelance mueve precios (web solo lectura; proveedor sin captura de costo)", apps:[null] },
  { arnes:"test_modulo_precios.js",  que:"Módulo «Precios» (PiladorasWeb modo=precios: directo a costos, recuerda piladora)", apps:[null] },
  { arnes:"test_precio_variedad.js", que:"Precio por variedad y piladora: la diferencia se propaga a cada marca", apps:[null] },
  ...
  { arnes:"test_modal_scroll.js",    que:"DISENO_MODAL_SCROLL: el modal «Asignar/Replicar piladoras» en tres zonas (cabecera fija · cuerpo con scroll · pie fijo con un solo botón) y todos los modales topados a la altura de la pantalla", apps:[null] },
  ...
  { arnes:"test_pedidos_busca_web.js", que:"PED-FE-003: Pedidos web se busca de servidor (cruza pestañas, cliente/RUC/vendedor por id), vista móvil en tarjetas y modal con proveedor/vendedor", apps:[null] },
